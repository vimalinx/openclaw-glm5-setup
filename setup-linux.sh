...
echo "🐧 Linux OpenClaw GLM-5 配置脚本"
echo "=================================="
echo ""
...
MODELS_FILE=""
for dir in \
  "$HOME/.config/nvm/versions/node"/v*/lib/node_modules/openclaw/node_modules/@mariozechner/pi-ai/dist/models.generated.js \
  ...
  "/usr/lib/node_modules/openclaw/node_modules/@mariozechner/pi-ai/dist/models.generated.js"; do
  if [ -f "$dir" ]; then
    MODELS_FILE="$dir"
    break
  fi
